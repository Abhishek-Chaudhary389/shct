...
import { getBetiSahyogReceipts, getApprovedMembers } from '../../services/dataService';

const AllSahayogList = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const data = await getBetiSahyogReceipts();
