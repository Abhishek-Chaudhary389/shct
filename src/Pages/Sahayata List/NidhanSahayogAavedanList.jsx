...
const NidhanSahayogAavedanList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setDataList(await getNidhanSahayogList());
    };
    fetchData();
  }, []);
    ...
    <div className="min-h-screen bg-white font-sans pb-12">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <div className="text-red-600 text-center font-medium text-[15px] space-y-3 mb-10">
          ...
          <p>2. असामयिक निधन पर आर्थिक मदद योजना में ऑनलाइन आवेदन के उपरांत आवेदक अपने जिले के FRCT जिलाध्यक्ष को फोन करके सामान्य सूचना जरूर दें</p>
        </div>
          ...
          <table className="w-full text-left border-collapse min-w-[1100px]">
            <thead>
              <tr className="bg-white text-gray-800 text-[13px] font-bold border-b-2 border-gray-200">
                ...
                <th className="p-4 border-r border-gray-100">मृत्यु<br/>तिथि</th>
                <th className="p-4 border-r border-gray-100 text-center">मृत्यु प्रमाण<br/>पत्र</th>
            ...
            <tbody className="text-[13px] text-gray-700">
              {filteredData.length > 0 ? (
                filteredData.map((item, index) => {
                  ...
                  return (
                    <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="p-4 border-r border-gray-100 bg-gray-50/50">{item.uniqueId?.replace('UID-', '697') || 'N/A'}</td>
                      <td className="p-4 border-r border-gray-100">{item.applicantName}</td>
                      <td className="p-4 border-r border-gray-100 whitespace-pre-wrap">{item.deathDate}</td>
                ...
                <tr>
                  <td colSpan="12" className="p-8 text-center text-gray-500 text-base">No data available in table</td>
                </tr>
              )}
            </tbody>
          </table>
